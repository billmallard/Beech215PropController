...
|---|---|---|---|---|---|
| Governor PCB | 100×80mm 2-layer FR4 | 5 | JLCPCB | ~$2 + shipping | Upload `hardware/350A_governor_JLCPCB.zip`; default settings; you get 5, use 1 |
...
| Ref | Part | Description | Digi-Key PN | Qty | Est. Cost |
|---|---|---|---|---|---|
...
| C2 | 100µF 25V | Electrolytic | 493-1215-ND | 1 | **POLARIZED** — observe polarity |
| C3 | 47µF 16V | Electrolytic | 493-1205-ND | 1 | **POLARIZED** — observe polarity |
...
| J3 | 1×5 2.54mm male header | 1 | 5-pin; or cut from 40-pin strip |
| PS1 | 1×5 2.54mm male header | 1 | 5-pin for LM2596 module |
| — | 40-pin 2.54mm male header strip | 1 | Break-apart; covers J1/J2/J3/PS1 |
...
**Panel pot:** This is the one part where getting it wrong has consequences. Audio taper (Type A, log) pots are far more common than linear taper (Type B) and are what's usually sold as "generic." Linear taper pots are labeled "B10K" or "Type B 10K." Audio taper pots are labeled "A10K" or "Type A 10K." **Buy Type B.** The Bourns PDB182-GTR42-103B2 is an excellent fit if you want a specific part number.
